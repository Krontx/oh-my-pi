...
| `app.clipboard.copyCodeBlock`| `Alt+Y`                                                               | Copy the newest assistant code block; press again to walk to older blocks (wraps after the oldest)                                                                                   |
| `app.clipboard.copyCodeBlockPrev` | `Alt+Shift+Y`                                                    | Copy the next newer code block in the walk                                                                                                                                           |
